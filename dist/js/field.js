...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_list_items_CheckedItem_vue__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_list_items_CheckedItem_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_list_items_CheckedItem_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_list_items_UncheckedItem_vue__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_list_items_UncheckedItem_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_list_items_UncheckedItem_vue__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    components: {
        CheckedItem: __WEBPACK_IMPORTED_MODULE_0__components_list_items_CheckedItem_vue___default.a,
        UncheckedItem: __WEBPACK_IMPORTED_MODULE_1__components_list_items_UncheckedItem_vue___default.a
    },
    ...
    methods: {
        getItemType: function getItemType(option) {
            return option.status ? 'checked-item' : 'unchecked-item';
        },
        getAllOptions: function getAllOptions() {
            var _this = this;

            return this.field.options.map(function (option) {
                return {
                    'status': _this.value[option.value],
                    'key': option.value,
                    'label': option.label
                };
            }).sort(function (x, y) {
        ...
        getCheckedOptions: function getCheckedOptions() {
            ...
            return this.field.options.filter(function (option) {
                return _this2.value[option.value];
            }).map(function (option) {
                return {
                    'status': true,
                    'key': option.value,
...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-checkboxes', __webpack_require__(4));
    Vue.component('detail-nova-checkboxes', __webpack_require__(13));
    Vue.component('form-nova-checkboxes', __webpack_require__(16));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_CheckboxDisplay__ = __webpack_require__(1);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_CheckboxDisplay__["a" /* default */]],
...
Component.options.__file = "resources/js/components/list-items/CheckedItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-986a5bf2", Component.options)
  } else {
    hotAPI.reload("data-v-986a5bf2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("li", { staticClass: "flex items-center mb-2" }, [
    _c("span", { staticClass: "text-success inline-block mr-4" }, [
      _c(
        "svg",
        {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-986a5bf2", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/list-items/UncheckedItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2c66a5e4", Component.options)
  } else {
    hotAPI.reload("data-v-2c66a5e4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("li", { staticClass: "flex items-center mb-2" }, [
    _c("span", { staticClass: "text-danger inline-block mr-4" }, [
      _c(
        "svg",
        {
          staticClass: "block fill-current h-4 w-4",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2c66a5e4", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        chunkedOptions: function chunkedOptions() {
            var _this = this;

            return this.optionList.reduce(function (result, option, index) {
                index %= _this.columns;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        optionValues: function optionValues() {
            ...
            return this.field.options.map(function (o) {
                return o.value;
            }).reduce(function (o, key) {
                return _extends({}, o, _defineProperty({}, key, _this.value.includes(key)));
            }, {});
        }
    },
